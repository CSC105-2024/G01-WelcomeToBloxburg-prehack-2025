...
function Navbar() {
  ...
  return (
    <div className='w-full bg-white h-[65px] flex justify-between px-4 font-nunito items-center shadow-md'>
      <div className="flex items-center">
        <h1
          className='md:mr-10 mr-4 text-3xl flex flex-nowrap cursor-pointer duration-300 hover:scale-110 active:scale-100'
