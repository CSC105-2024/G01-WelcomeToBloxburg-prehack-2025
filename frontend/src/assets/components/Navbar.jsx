...
function Navbar() {
  ...
  return (
    <div className='w-full bg-white  h-[65px] flex justify-around px-4  font-nunito items-center shadow-md'>
        <div>
            <h1 className='text-3xl flex flex-nowrap cursor-pointer duration-300 hover:scale-110 active:scale-100'onClick={() => window.location.href = "/dashboard"}><span>🚏</span>Here<span className='text-myPrimary'>We</span><span className='text-yellow-500'>Go</span></h1>
        </div>
